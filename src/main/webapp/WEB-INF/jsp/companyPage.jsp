...
<nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px" id="mySidebar">
  ...
  <div class="w3-padding-64 w3-large w3-text-grey" style="font-weight:bold">
   ...
   <form action="viewApprovedList" method="post">
...
<div class="w3-row-padding w3-padding-16" id="edit">
    ...
    <form action="editProfile" method="post">
      <div class="w3-section" >
        ...
        Email</label>
        <input class="w3-input w3-border" type="text" name="comEmail" required>
      </div>
      <div class="w3-section">
        <label><i class="fa fa-globe" aria-hidden="true"></i>
        WebSite</label>
        <input class="w3-input w3-border" type="text" name="comWebsite" required>
      </div>
      <div class="w3-section">
        <label><i class="fa fa-user" aria-hidden="true"></i>
        Name</label>
        <input class="w3-input w3-border" type="text" name="comName" required>
      </div>
      <div class="w3-section">
        <label><i class="fa fa-phone-square" aria-hidden="true"></i>
        Phone Number</label>
        <input class="w3-input w3-border" type="text" name="comPhno" required>
      </div>
      <div class="w3-section">
        <label><i class="fa fa-map-marker" aria-hidden="true"></i>
        Address</label>
        <input class="w3-input w3-border" type="text" name="comAddress" required>
      </div>
