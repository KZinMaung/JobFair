...
tr:nth-child(even) {background-color: #ccdcff;}
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  <div class="w3-container" style="margin-top:80px">
    ...
    <div class="w3-center w3-padding-64">
      <span class="w3-xlarge w3-bottombar w3-border-dark-grey w3-padding-16">Total Registered Students</span>
    </div>
    <table >
  ...
  <c:if test="${not empty registeredStds}">
			<c:forEach var="stds" items="${registeredStds}">
